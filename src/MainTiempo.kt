...
//                        }
    ...
    // Alg1
    private fun ordena1(v: IntArray, tam: Int) {
        var i: Int
        var j: Int
        var temp: Int
    ...
    // Alg2
    private fun ordena2(v: IntArray, tam: Int) {
        var k: Int
        val n = tam

        k = n / 2
        while (k >= 1) {
            f(v, k, n) // Suma las asignaciones de f()
            k--
        }
        k = n
        while (k > 1) {
            g(v, 1, k--)
            f(v, 1, k) // Suma las asignaciones de f()
        }
    }
    ...
    // Alg3
    private fun ordena3(v: IntArray, tam: Int){
